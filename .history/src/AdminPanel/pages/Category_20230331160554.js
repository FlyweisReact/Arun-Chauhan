        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number" min={0} onChange={(e) => setCommission(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Select aria-label="Default select example" onChange={(e) => setComFirst(e.target.value)} >
