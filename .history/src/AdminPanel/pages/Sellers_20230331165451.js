...
const Sellers = () => {
  ...
  const deleteHandler = async (id) => {
    try { 
      const { data } = await axios.delete(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:1112/api/seller/6419978da4762f89be7254bb`)
    }catch(e) {
      console.log(e)
    }
  }
              ...
              {data?.map((i, index) => (
                <tr key={index}>
                  ...
                  <td>
                    {" "}
                    <i
                      className="fa-solid fa-trash fa-beat-fade"
