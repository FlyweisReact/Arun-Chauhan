      ...
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100">
        ...
        >
          ...
          <section className="py-7 space-y-6">
            ...
            <button className="py-2 cursor-pointer tracking-wider bg-orange-600 flex justify-center items-center w-full rounded-md font-medium " onClick={() => navigate('//vendor/login')}>
              <div className="flex items-center">
                <span className="flex items-center justify-center">
                  Seller Panel
                </span>
