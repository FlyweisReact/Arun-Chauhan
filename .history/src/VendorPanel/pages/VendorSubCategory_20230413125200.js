...
const VendorSubCategory = () => {
  ...
  const fetchHandler = useCallback(async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/subCategory/seller/${sellorId}`
      );
      setData(data.result);
    } catch (e) {
      console.log(e);
  ...
  const fetchCategoryHandler = useCallback(async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/category/seller/${sellorId}`
      );
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/subcategory/${id}`
      );
