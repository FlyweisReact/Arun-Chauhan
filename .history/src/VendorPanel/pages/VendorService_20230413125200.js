...
const VendorService = () => {
  ...
  const fetchHandler = useCallback(async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/service/seller/${sellorId}`
      );
      setData(data.data);
    } catch (e) {
      console.log(e);
  ...
  const fetchSub = async () => {
    try {
      const { data } = await axios.get(
        "https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/subcategory/"
      );
  ...
  const fetchCat = async () => {
    try {
      const { data } = await axios.get(
        "https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/category"
      );
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/service",
          {
            serviceName: title,
            serviceImg: url,
            title,
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/service/${id}`
      );
