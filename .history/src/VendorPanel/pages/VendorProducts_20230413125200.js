  ...
  const fetchData = useCallback(async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/product/seller/${sellorId}`
      );
      setData(data.data);
    } catch (e) {
      console.log(e);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/product",
          fd
        );
        console.log(data);
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/api/product/${id}`
      );
      console.log(data);
