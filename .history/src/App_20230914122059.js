...
import VendorSubCategory from "./VendorPanel/pages/VendorSubCategory";
import VendorOrderHistory from "./VendorPanel/pages/VendorOrderHistory";
import SellerProduct from "./AdminPanel/pages/SellerProduct";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/installer-transaction/:id"
          element={<InstallerTransactions />}
        />
